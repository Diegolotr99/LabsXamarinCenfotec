    ...
    public class Person
    {
        ...
        public static async Task<ObservableCollection<Person>> GetPersons()
        {
            ...
            LstPersons = new ObservableCollection<Person>() {
                new Person(){IDPerson="123", Name="Diego", LastName="Gutierrez", SecondLastName="Castro", PhoneNumber="8888888", Picture="http://image.ibb.co/iHDecn/if_matureman2_628283_Cream.png" },
